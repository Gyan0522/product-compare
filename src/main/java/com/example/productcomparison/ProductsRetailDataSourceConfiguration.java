...
@EnableJpaRepositories(entityManagerFactoryRef = "secondaryEntityManagerFactory", transactionManagerRef = "secondaryTransactionManager", basePackages = {
		"com.example.productcomparison.repository.ProductsRetail" })
public class ProductsRetailDataSourceConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean secondaryEntityManagerFactory(
		...
		secondaryJpaProperties.put("hibernate.hbm2ddl.auto", "create");

		return secondaryEntityManagerFactoryBuilder.dataSource(secondaryDataSource)
				.packages("com.example.productcomparison.model.ProductsRetail").persistenceUnit("secondaryDataSource")
